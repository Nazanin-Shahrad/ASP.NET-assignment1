...
namespace MvcCake.Controllers
{
    public class CakesController : Controller
    {
        private readonly MvcCakeContext _context;

        public CakesController(MvcCakeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,ProductionDate,Comment,Weight,Price")] Cake cake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,ProductionDate,Comment,Weight,Price")] Cake cake)
        {
            if (id != cake.Id)
            {
                return NotFound();
